...
@Configuration
@EntityScan(basePackages = {"com.example.demo.Domain.Common.Entity"})                   //엔티티 위치
@EnableJpaRepositories(basePackages = {"com.example.demo.Domain.Common.Repository"})    //데이터 레포지토리 위치
